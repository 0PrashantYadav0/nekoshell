...
export function Themes() {
  ...
  return (
    <section className="section" id="themes">
      <div className="wrap">
        <Prompt cmd="nekoshell theme" args={flavour} out={<>four Catppuccin flavours; a switch re-renders every terminal, the prompt, bat, btop, lazygit, yazi and the rest; <b>theme auto</b> follows the Mac's appearance</>} />
        <div className="themes">
          ...
          <div>
            <p className="lead">Pick one. The page changes with it, the way every terminal on the Mac does.</p>
