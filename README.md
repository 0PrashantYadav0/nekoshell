...
**Look**: Catppuccin in any of its four flavours (mocha by default), JetBrainsMono Nerd Font, Starship prompt, eza, bat, fzf, zoxide, delta, btop, lazygit. `nekoshell-theme latte` moves the whole rig to another flavour in one command.
